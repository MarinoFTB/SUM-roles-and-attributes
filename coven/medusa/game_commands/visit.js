...
module.exports = function (game, message, params) {
  ...
  if (game.period >= 5) {
    ...
    if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
      ...
      actions.delete(x => x.from === from.identifier && x.identifier === "medusa/visit");

      message.channel.send(":snake: You have decided not to visit anyone tonight.");
      return null;
    };
    ...
    if (to.id === message.author.id) {
      ...
      game.addAction("medusa/visit", ["cycle"], {
        name: "medusa-visit",
        expiry: 1,
    ...
    message.channel.send(":snake: You have decided to visit **" + mention + "** tonight.");
